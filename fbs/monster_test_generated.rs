...
pub mod my_game {
    ...
    pub mod example {
        ...
        #[allow(non_camel_case_types)]
        const ENUM_NAMES_COLOR: [&'static str; 8] = ["Red", "Green", "", "", "", "", "", "Blue"];
        ...
        #[allow(non_camel_case_types)]
        const ENUM_NAMES_ANY_UNIQUE_ALIASES: [&'static str; 4] = ["NONE", "M", "T", "M2"];
        ...
        #[allow(non_camel_case_types)]
        const ENUM_NAMES_ANY_AMBIGUOUS_ALIASES: [&'static str; 4] = ["NONE", "M1", "M2", "M3"];
        ...
        impl<'a: 'b, 'b> TestSimpleTableWithEnumBuilder<'a, 'b> {
            ...
            pub fn add_color(&mut self, color: Color) {
                self.fbb_.push_slot::<Color>(
                    TestSimpleTableWithEnum::VT_COLOR,
                    color,
                    Color::Green,
                );
            }
            ...
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> TestSimpleTableWithEnumBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl<'a> Monster<'a> {
            ...
            pub fn test4(&self) -> Option<&'a [Test]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<Test>>>(
                        Monster::VT_TEST4,
                        None,
                    )
                    .map(|v| v.safe_slice())
            ...
            pub fn testarrayoftables(
                &self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Monster<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<Monster<'a>>>,
                >>(Monster::VT_TESTARRAYOFTABLES, None)
            }
            #[inline]
            pub fn enemy(&self) -> Option<Monster<'a>> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Monster<'a>>>(Monster::VT_ENEMY, None)
            }
            #[inline]
            ...
            pub fn testempty(&self) -> Option<Stat<'a>> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Stat<'a>>>(Monster::VT_TESTEMPTY, None)
            }
            #[inline]
            ...
            pub fn testarrayofsortedstruct(&self) -> Option<&'a [Ability]> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<Ability>>>(
            ...
            pub fn parent_namespace_test(&self) -> Option<super::InParentNamespace<'a>> {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<super::InParentNamespace<'a>>>(
            ...
            pub fn vector_of_referrables(
                &self,
            ) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Referrable<'a>>>>
            {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<flatbuffers::ForwardsUOffset<Referrable<'a>>>,
            ...
            pub fn any_unique_type(&self) -> AnyUniqueAliases {
                self._tab
                    .get::<AnyUniqueAliases>(
                        Monster::VT_ANY_UNIQUE_TYPE,
                        Some(AnyUniqueAliases::NONE),
                    )
                    .unwrap()
            }
            #[inline]
            ...
            #[inline]
            #[allow(non_snake_case)]
            pub fn test_as_test_simple_table_with_enum(
                &'a self,
            ) -> Option<TestSimpleTableWithEnum> {
                if self.test_type() == Any::TestSimpleTableWithEnum {
                    self.test()
                        .map(|u| TestSimpleTableWithEnum::init_from_table(u))
                } else {
                    None
                }
            }
            ...
            #[inline]
            #[allow(non_snake_case)]
            pub fn test_as_my_game_example_2_monster(
                &'a self,
            ) -> Option<super::example_2::Monster> {
                if self.test_type() == Any::MyGame_Example2_Monster {
                    self.test()
                        .map(|u| super::example_2::Monster::init_from_table(u))
                } else {
                    None
                }
            }
        ...
        pub struct MonsterArgs<'a> {
            ...
            pub testarrayoftables: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Monster<'a>>>,
                >,
            >,
            ...
            pub testarrayofstring2: Option<
                ...
                >,
            >,
            pub testarrayofsortedstruct:
                Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, Ability>>>,
        ...
        impl<'a: 'b, 'b> MonsterBuilder<'a, 'b> {
            ...
            pub fn add_test4(
                &mut self,
                test4: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Test>>,
            ) {
                self.fbb_
            ...
            pub fn add_testempty(&mut self, testempty: flatbuffers::WIPOffset<Stat<'b>>) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Stat>>(
                    Monster::VT_TESTEMPTY,
                    testempty,
                );
            }
            #[inline]
            ...
            pub fn add_test5(
                &mut self,
                test5: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Test>>,
            ) {
                self.fbb_
            ...
            pub fn add_single_weak_reference(&mut self, single_weak_reference: u64) {
                self.fbb_.push_slot::<u64>(
                    Monster::VT_SINGLE_WEAK_REFERENCE,
            ...
            pub fn add_vector_of_co_owning_references(
                &mut self,
                vector_of_co_owning_references: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, u64>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Monster::VT_VECTOR_OF_CO_OWNING_REFERENCES,
            ...
            pub fn add_non_owning_reference(&mut self, non_owning_reference: u64) {
                self.fbb_.push_slot::<u64>(
                    Monster::VT_NON_OWNING_REFERENCE,
            ...
            pub fn add_vector_of_non_owning_references(
                &mut self,
                vector_of_non_owning_references: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, u64>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
